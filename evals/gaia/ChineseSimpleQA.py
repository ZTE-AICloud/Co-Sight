...
def extract_fields_from_jsonl(target_id, jsonl_file="Chinese-SimpleQA/sampled_chinese_simpleqa.jsonl"):
    """
...
def chinesesimpleqa(
    process_message,
    task_id: str  = "97e7f58a3b154facaa3a5c64d678c7bf",
    file_path: str  = "Chinese-SimpleQA/chinese_simpleqa.jsonl",
...
def chinesesimpleqa_multi_route(
    process_message,
    task_id: str  = "97e7f58a3b154facaa3a5c64d678c7bf",
    file_path: str  = "Chinese-SimpleQA/chinese_simpleqa.jsonl",
    first_task_id: str = None,
